...
{
  name: 'Abhi and Atul', link: 'https://atul-abhi-web.vercel.app/', status: 'Inprogress', description: 'Sound and Lights services', logo: <svg width="50" height="50" viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
